...
var r1=RunningWorkout(distance:10, time: 20)
var r2=SwimmingWorkout(distance:30, time: 50)

simpleWorkoutDescription(workout:r1)
simpleWorkoutDescription(workout:r2)
