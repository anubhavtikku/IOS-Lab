 ...
 */
var walkingChallenges:[String]=["Walk 3 miles a day","Walk 7 miles a day"]

var runningChallenges:[String]=["Run 3 miles a day","Run 7 miles a day"]
/*:
...
{
    print("The challenge is \(committedChallenges[0])")
}
else
{
    print("The user has chosen multiple challenges")
}
