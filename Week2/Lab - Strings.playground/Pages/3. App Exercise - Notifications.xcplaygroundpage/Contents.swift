...
let firstName:String="Anubhav"
let lastName:String="Tikku"
...
let newBest = 15125
let congragulations:String="Congratulations, \(fullName)! You beat your previous daily high score of \(previousBest) steps by walking \(newBest) steps yesterday!"
