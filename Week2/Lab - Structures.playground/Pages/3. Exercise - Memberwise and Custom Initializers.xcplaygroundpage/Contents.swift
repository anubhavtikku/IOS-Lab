...
let b=Book(title:"Angels and Demons", author:"Dan Brown", pages:300, price:200)
print("My favorite book is \(b.title) by \(b.author) , price \(b.price) and pages \(b.pages)")
...
print("Height in cm is \(someonesHeight.heightInCentimeters) and that is \(someonesHeight.heightInCentimeters==165.1)")
/*:
 ...
 */
var myHeight=Height(cm:173)
print("My height in inches is \(myHeight.heightInInches) and thats \(myHeight.heightInInches*2.54==myHeight.heightInCentimeters)")
