...
print("Foo variable has local scope and doesnt exist outside for loop ")
/*:
...
print("x has global scope and is modified inside for loop(Global scope)\nfoo was defined in local scope")
